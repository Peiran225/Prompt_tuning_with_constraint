#!/bin/bash
#SBATCH --job-name=L2_p_similarity  # Specify a name for your job
#SBATCH --output=outputs/L2_similarity.log       # AUC_converge.log  Specify the output log file
#SBATCH --error=errors/L2_p_similarity.log        # Specify the error log file
