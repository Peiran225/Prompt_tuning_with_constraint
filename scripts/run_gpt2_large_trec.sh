...
#SBATCH --output=outputs/gpt2_large_trec.log       # AUC_converge.log  Specify the output log file
#SBATCH --error=errors/gpt2_large_trec.log        # Specify the error log file
...
for GAMMA in 5e-5 
# GAMMA working: 5e-5(best) 1e-6 3e-6 4e-6 5e-6  
do
