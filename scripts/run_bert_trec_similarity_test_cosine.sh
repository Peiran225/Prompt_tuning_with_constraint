#!/bin/bash
#SBATCH --job-name=cosine_similarity  # Specify a name for your job
#SBATCH --output=outputs/cosine_similarity.log       # AUC_converge.log  Specify the output log file
#SBATCH --error=errors/cisine_similarity.log        # Specify the error log file
...
PROMPT="trec_1"
PROMPT_GROUP="TRUE"
SIMILARITY="cosine_LM"
PARTICULAR_LAYER=3


for SIMILARITY in "L2_prompt_LM" "L2_prompt_part_LM" "L2_prompt_part_LM" "L2_prompt_part_LM"
