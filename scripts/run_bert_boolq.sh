#!/bin/bash
#SBATCH --job-name=B-boolq # Specify a name for your job
#SBATCH --output=outputs/bert_boolq.log       # AUC_converge.log  Specify the output log file
#SBATCH --error=errors/bert_boolq.log        # Specify the error log file
...
do
    python3 main_mean_of_prompts.py --learning_rate=$LEARNING_RATE --learning_rate_LM=$LEARNING_RATE  \
                             ...
                             --seed=$SEED --prompt_group=$PROMPT_GROUP
done
