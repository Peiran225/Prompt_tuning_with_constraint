#!/bin/bash
#SBATCH --job-name=cosine_p_similarity # Specify a name for your job
#SBATCH --output=outputs/cosine_p_similarity.log       # AUC_converge.log  Specify the output log file
#SBATCH --error=errors/cosine_p_similarity.log        # Specify the error log file
...
PROMPT="trec_1"
PROMPT_GROUP="TRUE"
SIMILARITY="cosine_prompt_part_LM"
PARTICULAR_LAYER=3
